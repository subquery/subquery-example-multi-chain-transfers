...
export async function ensureAccount(accountId:string, publicKey:string): Promise<void> {
...
export async function handleEvent(event: SubstrateEvent): Promise<void> {
  ...
  await Promise.all([ensureAccount(fromAddress.toString(),fromPk),ensureAccount(toAddress.toString(),toPk)])
...
export async function updateBalance(account:string, publicKey:string,blockHeight:bigint){
